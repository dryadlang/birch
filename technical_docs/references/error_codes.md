...
Lista completa dos códigos de erro emitidos pelo compilador e runtime da Dryad, com dicas de resolução.
...
| **6002** | Import circular | Arquivo A importa B que importa A. | Refatore para remover a dependência cíclica. |
